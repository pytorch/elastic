...
class CoordinatorP2P(Coordinator):
    ...
    def __init__(
        ...
        assert coordinator_pg_timeout > process_group_timeout, (
            "coordinator_pg_timeout {} (ms) must greater than "
    ...
    def rendezvous_barrier(self):
        ...
        try:
            ...
            message = {"word_size": self.world_size}
            self._log_event("rendezvous_succeeded", message)
    ...
    @metrics.profile("torchelastic")
    def on_error(self, e):
        self._log_event("pet_runtime_error")
        log.error(
            "Rank: {0}\n"
            "Error: {1}\n"
            "ErrorType: {2}\n"
